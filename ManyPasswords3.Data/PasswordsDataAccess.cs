...
namespace ManyPasswords3.Data
{
    public static class PasswordsDataAccess
    {
        ...
        //{
        //    var file = folder.CreateFileAsync("manypasswords.db", CreationCollisionOption.OpenIfExists).GetAwaiter().GetResult();
        ...
        //            "description TEXT," +
        //            "color INTEGER);";
        //    SqliteCommand createGlossaryTable = new SqliteCommand(glossaryTableCommand, _passwordsDb);
        ...
        //        SqliteCommand selectCommand = new SqliteCommand($"SELECT * FROM glossaryCategory", _passwordsDb);
        ...
        //        selectCommand = new SqliteCommand(sql, _passwordsDb);
        ...
        //    try
        //    {
        //        SqliteCommand deleteWordsCommand = new SqliteCommand($"DELETE FROM glossary WHERE id=$id;", _passwordsDb);
        ...
        //    try
        //    {
        //        SqliteCommand selectWordsCommand = new SqliteCommand($"SELECT 1 FROM glossary WHERE wordid=$wordid AND glossaryid=$glossaryid;", _passwordsDb);
